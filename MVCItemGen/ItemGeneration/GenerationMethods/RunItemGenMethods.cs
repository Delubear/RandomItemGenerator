...
namespace RPGItemGenerator.ItemGeneration
{
    public partial class RunItemGen
    {
        ...
        public void AppendtemProperties(BaseItemModel testItem)
        {
        ...
        private void SetTextColor(BaseItemModel testItem)
        {
        ...
        public BaseItemModel GetItemType(Dictionary<string, HashSet<string>> itemBaseName, string rarity = "")
        {            
            int x = 0;
            x = rnd.Next(0, 3);
            BaseItemModel testItem;
            Rarity rare;
